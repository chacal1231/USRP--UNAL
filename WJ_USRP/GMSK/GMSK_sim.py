...
# Generated: Thu Aug 18 17:05:00 2016
##################################################
...
class GMSK_sim(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.throttle_var_0 = throttle_var_0 = 100e3
        self.sps = sps = 2
        self.eb = eb = 0.35
        ...
        # Blocks
        ##################################################
        self._throttle_var_0_range = Range(32e3, 1e6, 1e3, 100e3, 200)
        ...
        self.blocks_delay_0 = blocks.delay(gr.sizeof_char*1, 100)
        ...
        self.connect((self.blks2_packet_decoder_0, 0), (self.blocks_delay_0, 0))    
        self.connect((self.blks2_packet_encoder_0, 0), (self.digital_gmsk_mod_0, 0))    
        self.connect((self.blocks_add_xx_0, 0), (self.digital_gmsk_demod_0, 0))    
        self.connect((self.blocks_delay_0, 0), (self.blocks_udp_sink_0, 0))    
