...
# Title: Qpsk Tx
# Generated: Tue Aug 16 09:51:48 2016
##################################################
...
class QPSK_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._gain_RF_range = Range(0, 31.5, 0.5, 10, 200)
        ...
        self.uhd_usrp_sink_0.set_gain(gain_RF, 0)
        self.uhd_usrp_sink_0.set_antenna("TX/RX", 0)
        self._rate_range = Range(50e3, 1000e3, 100, 200e3, 200)
        ...
        self.blocks_file_source_2 = blocks.file_source(gr.sizeof_char*1, "/home/unal/Desktop/USRP--UNAL/RADIO_oF/tx_data (another copy).dat", True)
        ...
        self.connect((self.blocks_file_source_2, 0), (self.blks2_packet_encoder_0, 0))    
        self.connect((self.blocks_file_source_2, 0), (self.blocks_char_to_float_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.qtgui_freq_sink_x_0, 0))    
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.uhd_usrp_sink_0, 0))    
        self.connect((self.digital_pfb_clock_sync_xxx_0, 0), (self.qtgui_const_sink_x_0, 0))    
        self.connect((self.digital_qam_mod_0, 0), (self.blocks_add_xx_0, 1))    
    ...
    def set_gain_RF(self, gain_RF):
        ...
        self.uhd_usrp_sink_0.set_gain(self.gain_RF, 0)
